...
import Svg, { Rect, Defs, LinearGradient, Stop, Path, Circle, Pattern, Use } from 'react-native-svg';
...
const BackIcon = () => (
    <Svg width="18" height="28" viewBox="0 0 18 28" fill="none">
        <Path d="M17.0824 1.04755L2.04125 13.9999L16.9999 27.0474" stroke="black" strokeWidth="4" />
    </Svg>
);
// SVG component for the profile picture circle
const ProfilePicture = () => (
    <Svg width="103" height="103" viewBox="0 0 133 133" fill="none">
        <Circle cx="66.5" cy="66.5" r="65" fill="url(#pattern0)" stroke="url(#paint0_linear_113_7)" strokeWidth="3" />
        <Defs>
            <Pattern id="pattern0" patternContentUnits="objectBoundingBox" width="1" height="1">
                <Use xlinkHref="#image0_113_7" transform="translate(0 -0.244186) scale(0.00581395)" />
            </Pattern>
            <LinearGradient id="paint0_linear_113_7" x1="66.5" y1="0" x2="66.5" y2="133" gradientUnits="userSpaceOnUse">
...
const UserIcon = () => (
    <Svg width="35" height="35" viewBox="0 0 35 35" fill="none">
        <Path d="M9.75 10.9375C9.75 5.23392 13.4354 1 17.5 1C21.5646 1 25.25 5.23392 25.25 10.9375C25.25 16.6411 21.5646 20.875 17.5 20.875C13.4354 20.875 9.75 16.6411 9.75 10.9375ZM1 30.625C1 26.5975 4.05072 23.3207 7.94664 22.9088C10.4356 25.5442 13.7939 27.25 17.5 27.25C21.2063 27.25 24.5648 25.544 27.0538 22.9083C30.9845 23.3182 34 26.5926 34 30.625V34H1V30.625Z" fill="#D9D9D9" stroke="#0C0C0C" strokeWidth="2" />
    </Svg>
);
...
const TimezoneIcon = () => (
    <Svg width="35" height="35" viewBox="0 0 37 38" fill="none">
        <Path d="M1 15C1 29 18.5 36 18.5 36C18.5 36 36 29 36 15C36 7.27083 28.1688 1 18.5 1C8.83125 1 1 7.27083 1 15Z" stroke="#0C0C0C" strokeWidth="2" />
        <Path d="M18.5 19.7833C21.8247 19.7833 24.52 17.5373 24.52 14.7667C24.52 11.996 21.8247 9.75 18.5 9.75C15.1752 9.75 12.48 11.996 12.48 14.7667C12.48 17.5373 15.1752 19.7833 18.5 19.7833Z" stroke="#0C0C0C" strokeWidth="2" />
    </Svg>
);
            ...
            <View style={styles.rectangles}>
                <View style={{ marginBottom: 15, position: 'relative' }}>
                    <Svg width="307" height="62" viewBox="0 0 347 71" fill="none">
                        <Rect x="1.5" y="1.5" width="344" height="68" rx="18.5" fill="#D9D9D9" stroke="url(#paint0_linear_114_4)" strokeWidth="3" />
                        <Defs>
                            <LinearGradient id="paint0_linear_114_4" x1="173.5" y1="0" x2="173.5" y2="71" gradientUnits="userSpaceOnUse">
                                <Stop stopColor="#B80DCA" />
                                <Stop offset="1" stopColor="#4035CB" />
                            </LinearGradient>
                        </Defs>
                    </Svg>
                    <Text style={{ position: 'absolute', top: 15, left: 20, width: 144, height: 35, color: '#000', fontFamily: 'Rosarivo', fontSize: 22, fontWeight: '400', letterSpacing: 0.44 }}>User name</Text>
                ...
                <View style={{ marginBottom: 15, position: 'relative' }}>
                    ...
                    <Text style={{ position: 'absolute', top: 15, left: 20, width: 257, color: '#000', fontFamily: 'Rosarivo', fontSize: 22, fontWeight: '400', letterSpacing: 0.44 }}>Location/ Timezone</Text>
                    <View style={{ position: 'absolute', top: 15, right: 10 }}>
                        <TimezoneIcon />
                    </View>
                </View>
