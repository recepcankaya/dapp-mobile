...
type AddTaskScreenNavigationProp = BottomTabNavigationProp<TabParamList, 'Add Task'>;
            ...
            <View style={styles.taskInputHeaderContainer}>
              ...
              >
                ...
                <View style={styles.taskIconContainer}>
                  <TouchableOpacity style={styles.taskIcon1} onPress={createMission}>
                    <Image source={require('./assets/ic_positive.png')} />
                  </TouchableOpacity>
                  <TouchableOpacity style={styles.taskIcon2} onPress={() => setTitle('')}>
