...
const AdminInfoList = ({ data, refreshing, onRefresh, containerStyle, weeklyTotalOrders }: InfoListProps) => {
    console.log("weeklyTotalOrders-2", weeklyTotalOrders);
    return (
        <ScrollView style={[styles.container, containerStyle]} refreshControl={
