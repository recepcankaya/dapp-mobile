        ...
        <View style={[styles.container, { paddingTop: statusBarHeight }]}>
            <View style={styles.main}>
                ...
                <View style={styles.logoContainer}>
                    <TouchableOpacity style={styles.qrCodeContainer} onPress={() => navigation.navigate("Admin Camera")}>
                        <Text style={styles.qrCodeText}>
                            Qr Kodu Okut
                        </Text>
                    </TouchableOpacity>
                    <Image source={{ uri: brandLogo.replace("ipfs://", "https://ipfs.io/ipfs/") }} style={styles.logo} />
                </View>
            </View>
        </View>
    )
