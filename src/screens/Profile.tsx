        ...
        <View style={styles.container}>
            ...
            <View style={styles.tabsContainer}>
                <TouchableOpacity onPress={() => setSelectedTab('Waiting')}>
                    <Text style={[styles.waitingTabText, selectedTab === 'Waiting' && styles.selectedTab]}>Waiting</Text>
                </TouchableOpacity>
                <TouchableOpacity onPress={() => setSelectedTab('Your Collection')}>
                    <Text style={[styles.collectionTabText, selectedTab === 'Your Collection' && styles.selectedTab]}>Your Collection</Text>
                </TouchableOpacity>
            </View>
